    ...
    <div class="container">
        <div class="flat-title wow fadeInUp title-upper" data-wow-delay="0s">
            ...
            <div class="d-flex gap-16 align-items-center box-pagi-arr">
                ...
                <a href="<?= route_to('product_shop') ?>"
                    class="tf-btn btn-line fs-12 fw-6  btn-line-light"><?= lang('Home.best_sell_view_all_btn') ?></a>
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="card-product style-brown">
                            <div class="card-product-wrapper rounded-0">
                                <a href="<?= base_url(route_to('product_detail', $product->pd_slug, $product->id)) ?>"
                                    ...
                                    <img class="lazyload img-product"
                                        data-src="<?= $product->feature_image['thumbnail'] ?>"
                                        src="<?= $product->feature_image['thumbnail'] ?>"
                                        alt="<?= $product->pd_name ?>">
                                ...
                                <div class="list-product-btn absolute-2">
                                    ...
                                    <a href="#shoppingCart" data-bs-toggle="modal" @click="addCart(<?= $product->id ?>)"
                            ...
                            <div class="card-product-info">
                                <a href="<?= base_url(route_to('product_detail', $product->pd_slug, $product->id)) ?>"
                                    class="title link  text-white"><?= $product->pd_name ?></a>
