<aside class="tf-section-sidebar wrap-sidebar-mobile">
    ...
    echo view_cell('\App\Cells\Widgets\CategoryListCell', null);
    ?>
    ...
    echo view_cell('\App\Cells\Widgets\NewPostListCell', null);
    ?>
    ...
    echo view_cell('\App\Cells\Widgets\TagsListCell', ['postTags' => json_decode($post->tags, true)]);
    ?>
