    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-xl-8">
                ...
                <div class="content-block post-list-view mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="<?=base_url($configs->templatePath)?>/assets/images/post-images/post-list-02.jpg" alt="Post Images">
                        </a>
                ...
                <div class="content-block post-list-view mt--30">
                    <div class="post-thumbnail post-gallery-activation axil-slick-arrow arrow-between-side">
                        <a href="post-details.html">
                            <img src="<?=base_url($configs->templatePath)?>/assets/images/post-images/post-list-04.jpg" alt="Post Images">
                        </a>
                        <a href="post-details.html">
                            <img src="<?=base_url($configs->templatePath)?>/assets/images/post-images/post-list-01.jpg" alt="Post Images">
                        </a>
                        <a href="post-details.html">
                            <img src="<?=base_url($configs->templatePath)?>/assets/images/post-images/post-list-02.jpg" alt="Post Images">
                        </a>
                ...
                <div class="content-block post-list-view mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="<?=base_url($configs->templatePath)?>/assets/images/post-images/post-list-05.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
            ...
            <div class="col-lg-4 col-xl-4 mt_md--40 mt_sm--40">
                <!-- Start Sidebar Area  -->
                <?= view('layouts/_sidebar', ['configs' => $configs]) ?>
                <!-- End Sidebar Area  -->
