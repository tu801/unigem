            ...
            <div class="col-xl-9 col-md-4 col-6">
                <div class="wrap-header-left">
                    <a href="<?= base_url() ?>" class="logo-header">
                        <img src="<?= get_logo_url($configs) ?>" alt="<?= get_theme_config('general_site_title') ?>"
                            class="logo">
                    </a>
                    <nav class="box-navigation text-center">
                        <?php echo view_cell('\App\Cells\Menu\MenuTopCell') ?>
                    </nav>
                </div>
            </div>
            <div class="col-xl-3 col-md-4 col-3">
                <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                    ...
                    <li class="nav-account">
                        ...
                        <?php else : ?>
                        <a href="#login" data-bs-toggle="modal" class="nav-icon-item"><i
                    ...
                    <li class="nav-cart">
                        <a href="#shoppingCart" data-bs-toggle="modal" class="nav-icon-item">
                            ...
                            <span class="count-box">{{ carts.length }}</span>
                        </a>
                    </li>
                </ul>
            </div>
