                            ...
                            <div class="filter_list">
                                <?php foreach ($product_category as $item): ?>
                                    <div class="custom_check d-flex align-items-center">
                                        <input type="checkbox" name="category[]" class="check_inp" value="<?= $item->id ?>" class="check_inp" hidden id="cat-<?= $item->id ?>" <?= isset($select_cat) && in_array($item->id,$select_cat) ? 'checked' : '' ?>>
                        ...
                        <div class="shop_filter">
                            ...
                            <div class="filter_list">
                                <?php foreach ($product_manufacturer as $item): ?>
                                    <div class="custom_check d-flex align-items-center">
                                        <input type="checkbox" name="manufacturer[]" class="check_inp" value="<?= $item->manufacturer_id ?>" hidden id="bnd-<?= $item->manufacturer_id ?>" <?= isset($select_manufacturer) && in_array($item->manufacturer_id,$select_manufacturer) ? 'checked' : '' ?>>
                            ...
                            <div class="single_new_arrive">
                                ...
                                <div class="sna_content">
                                    ...
                                    <div class="product_adcart">
                                        <button data-product-id="<?= $item->id ?>" @click="addCart(<?= $item->id ?>)" class="default_btn add_product_to_card"><?= lang('Product.add_cart') ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
