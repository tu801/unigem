                            ...
                            <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom"
                                ...
                                <div class="swiper-wrapper stagger-wrap">
                                    ...
                                    <div class="swiper-slide stagger-item" data-color="beige">
                                        <div class="item">
                                            <img class="lazyload" data-src="<?= base_url($item->full_image) ?>"
                                                src="<?= base_url($item->full_image) ?>"
                                                alt="<?= $product->pd_name ?? '' ?>">
                                        </div>
                                    </div>
                                    <?php
                                        ...
                                        ?>
                                    <div class="item">
                                        <img class="lazyload" data-src="<?= $featureImg ?>" src="<?= $featureImg ?>"
                                            alt="<?= $product->pd_name ?? '' ?>">
                                    </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide" data-color="beige">
                                        <a href="<?= base_url($item->full_image) ?>" target="_blank" class="item"
                                            data-pswp-width="770px" data-pswp-height="770px">
                                            <img class="tf-image-zoom lazyload"
                                                data-zoom="<?= base_url($item->full_image) ?>"
                                                data-src="<?= base_url($item->full_image) ?>"
                                                src="<?= base_url($item->full_image) ?>"
                                                alt="<?= $product->pd_name ?? '' ?>">
                                        </a>
                                    </div>
                                    ...
                                    <div class="swiper-slide" data-color="beige">
                                        <a href="<?= $featureImg ?>" target="_blank" class="item"
                                            data-pswp-width="770px" data-pswp-height="770px">
                                            <img class="tf-image-zoom lazyload" data-zoom="<?= $featureImg ?>"
                                                data-src="<?= $featureImg ?>" src="<?= $featureImg ?>"
                                                alt="<?= $product->pd_name ?? '' ?>">
                                        </a>
                                    </div>
                                    <?php endif; ?>
                        ...
                        <div class="tf-product-info-list other-image-zoom">
                            ...
                            <div class="tf-product-info-price">
                                ...
                                <div class="badges-on-sale">
                                    <span><?= round((($product->price - $product->price_discount) / $product->price) * 100) ?></span>%
                                    OFF
                                </div>
                            ...
                            <div class="tf-product-weight">
                                <p class="fw-6 w-100"><?= lang('Product.pd_weight') ?> : <?= $product->pd_weight ?>
                                    &nbsp;<?= lang('Common.product_weight_unit') ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="tf-product-cut-angle">
                                <p class="fw-6 w-100"><?= lang('Product.pd_cut_angle') ?> :
                                    <?= $product->pd_cut_angle ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    ?>
                                    <a href="#addCart" @click="addCart(<?= $product->id ?>)"
                            ...
                            <div class="tf-product-info-extra-link">
                                ...
                                <a href="#delivery_return" data-bs-toggle="modal" class="tf-product-extra-icon">
                                    <div class="icon">
                                        <svg class="d-inline-block" viewBox="0 0 22 25" width="22" height="18"
                            ...
                            <div class="tf-product-info-trust-seal">
                                ...
                                <div class="tf-payment">
                                    <img width="42px"
                                        src="<?= base_url($configs->templatePath) ?>images/payments/visa.png"
                                        alt="<?= get_theme_config('general_site_title') ?>">
                                    <img width="42px"
                                        src="<?= base_url($configs->templatePath) ?>images/payments/img-1.png"
                                        alt="<?= get_theme_config('general_site_title') ?>">
                                    <img width="42px"
                                        src="<?= base_url($configs->templatePath) ?>images/payments/img-2.png"
                                        alt="<?= get_theme_config('general_site_title') ?>">
                                    <img width="42px"
                                        src="<?= base_url($configs->templatePath) ?>images/payments/img-3.png"
                                        alt="<?= get_theme_config('general_site_title') ?>">
                                    <img width="42px"
                                        src="<?= base_url($configs->templatePath) ?>images/payments/img-4.png"
                                        alt="<?= get_theme_config('general_site_title') ?>">
                                </div>
                            </div>
                        </div>
            ...
            <div class="tf-height-observer w-100 d-flex align-items-center">
                <div class="tf-sticky-atc-product d-flex align-items-center">
                    <div class="tf-sticky-atc-img">
                        ...
                        $featureImg = (isset($product->feature_image['thumbnail']) && $product->feature_image['thumbnail'] !== null) ? $product->feature_image['thumbnail'] : base_url($configs->no_img);
                        ?>
                        <img class="lazyloaded" data-src="<?= $featureImg ?>" alt="<?= $product->pd_name ?? '' ?>"
                            src="<?= $featureImg ?>">
                    </div>
