            ...
            <div class="col-lg-9">
                <div class="my-account-content account-dashboard">
                    ...
                    <div class="text-center widget-inner-address">
                        <form class="wd-form-address mt-0" id="formnewAddress" action="<?=route_to('edit_shipping_address', $shipAddress->id)?>" method="post">
                            <?= csrf_field() ?>
                                                        
                            <div class="box-field">
                                <div class="tf-field style-1">
                                    <input class="tf-field-input tf-input" placeholder=" " type="text" id="shipToName" name="ship_full_name" value="<?= $shipAddress->ship_full_name ?? old('ship_full_name') ?>">
                                    <label class="tf-field-label fw-4 text_black-2" for="shipToName"><?=lang('Customer.ship_full_name')?> *</label>
                                </div>
                            </div>
                            <div class="box-field">
                                <div class="tf-field style-1">
                                    <input class="tf-field-input tf-input" placeholder=" " type="text" id="shipTelephone" name="ship_telephone" value="<?= $shipAddress->ship_telephone ?? old('ship_telephone') ?>">
                                    <label class="tf-field-label fw-4 text_black-2" for="shipTelephone"><?=lang('Customer.ship_telephone')?> *</label>
                                </div>
                            </div>
                            <div class="box-field">
                                <div class="tf-field style-1">
                                    <input class="tf-field-input tf-input" placeholder=" " type="email" id="shipEmail" name="ship_email" value="<?= $shipAddress->ship_email ?? old('ship_email') ?>">
                            ...
                            <div class="box-field">
                                ...
                                <div class="select-custom">
                                    <select class="tf-select w-100" id="country" name="country_id" country-selected="<?= old('country_id') ?? $shipAddress->country_id ?>">
                            ...
                            <div id="vietnam_address">
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        <select class=" w-100 select_province" id="province" name="province_id" area-selected="<?= $shipAddress->province_id ?? old('province_id') ?>"></select>
                                    </div>
                                </div>
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        <select class=" w-100 select_district" id="district" name="district_id" area-selected="<?= $shipAddress->district_id ?? old('district_id') ?>"></select>
                                    </div>
                                </div>
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        <select class=" w-100 select_ward" id="ward" name="ward_id" area-selected="<?= $shipAddress->ward_id ?? old('ward_id') ?>"></select>
                                    </div>
                                </div>
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        <input class="tf-field-input tf-input" placeholder=" " type="text" name="ship_address" value="<?= $shipAddress->ship_address ?? old('ship_address') ?>">
                            ...
                            <div class="box-field text-start">
                                ...
                                <?php
                                if (isset($shipAddress->is_default) && $shipAddress->is_default == 1) {
                                    $checked = 'checked';
                                }
                                ?>
                                    <input type="checkbox" id="check-new-address" class="tf-check" name="is_default" value="1" <?= $checked ?? '' ?>>
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-20">
                                <button type="submit" class="tf-btn btn-fill animate-hover-btn"><?=lang('Common.save_changes')?></button>
                            </div>
                        </form>
