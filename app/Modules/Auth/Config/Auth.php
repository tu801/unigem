...
class Auth
{
    ...
    public $authenticationLibs = [
        'local' => 'Modules\Auth\Authentication\LocalAuthenticator',
    ];
    ...
    public $views = [
        'login'		        => 'Modules\Auth\Views\Auth\login',
        'register'		    => 'Modules\Auth\Views\Auth\register',
        'forgot'		    => 'Modules\Auth\Views\Auth\forgot',
        'reset'		        => 'Modules\Auth\Views\Auth\reset',
        'emailForgot'	    => 'Modules\Auth\Views\Auth\emails\forgot',
        'emailActivation'   => 'Modules\Auth\Views\Auth\emails\activation',
        'changePass'        => 'Modules\Auth\Views\Auth\change_pass',
        'messageBlock'      => 'Modules\Auth\Views\templates\_message_block',
    ];
     ...
     * @var string
     */
    public $viewLayout = 'Modules\Auth\Views\layout';
     ...
     */
    public $requireActivation = 'Modules\Auth\Authentication\Activators\EmailActivator';
     ...
     */
    public $activeResetter = 'Modules\Auth\Authentication\Resetters\EmailResetter';
    ...
    public $passwordValidators = [
        'Modules\Auth\Authentication\Passwords\CompositionValidator',
        'Modules\Auth\Authentication\Passwords\NothingPersonalValidator',
        'Modules\Auth\Authentication\Passwords\DictionaryValidator',
        // 'Modules\Auth\Authentication\Passwords\PwnedValidator',
    ];
