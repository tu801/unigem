...
<div class="row">
    ...
    <div class="card card-primary card-outline">
        ...
        <?=form_open(route_to('edit_user_permission', $userData->id))?>
        <div class="card-body">
            <div class="row">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="icheck-primary permissions">
                                    <input class="" type="checkbox" <?=(in_array($per->id, array_keys($userData->permissions)))?'checked':''?> value="<?=$per->id?>" name="pers[]" id="perCheck<?=$per->id?>">
