                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            <div
                                class="col-12 col-sm-8 col-md-4 px-0 d-flex justify-content-md-end justify-content-center mx-md-0 mx-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm mb-2"
                                                    href="<?= base_url(route_to("view_contact", $row->id)) ?>"><i
                                                        class="fas fa-eye"></i></a>
                                                <a class="btn btn-danger btn-sm mb-2 acpRmItem" title="Move to Trash"
                                                    data-delete="<?= route_to("remove_contact") ?>" data-id="<?= $row->id ?>"
