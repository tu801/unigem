    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item d-flex align-items-center" href="#"
                                                data-currency="USD">
                                                <img src="https://flagcdn.com/w20/us.png" alt="USD" class="me-2"
                                                    width="20">
                                                USD
                                            </a>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="currency-input-container">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="currency_to" value="VND">
                                    <input type="number" class="form-control form-control-lg text-center" name="rate"
                                        id="toAmount" value="<?= number_format($onlineExchangeRate, 2, '.', '') ?>"
                                        style="font-size: 1.5rem; font-weight: bold; background-color: #f8f9fa;">
                                </div>
                            </div>
                        </div>
                ...
                <!-- Thông tin tỷ giá -->
                <?php if (isset($exchangeRate->id)): ?>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="alert alert-light border">
                                <div class="row">
                                    <div class="col-md-4">
                                        <small class="text-muted"><?= lang('Shop.currency_from') ?>:</small>
                                        <div class="font-weight-bold text-info"><?= $exchangeRate->currency_from ?></div>
                                    </div>
                                    <div class="col-md-4">
                                        <small class="text-muted"><?= lang('Shop.current_exchange_rate') ?>:</small>
                                        <div class="font-weight-bold">
                                            <?= "1 {$exchangeRate->currency_from} = {$exchangeRate->rate} {$exchangeRate->currency_to}" ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <small class="text-muted"><?= lang('Shop.last_update') ?>:</small>
                                        <div class="font-weight-bold">
