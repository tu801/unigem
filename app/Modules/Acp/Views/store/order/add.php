                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="note" placeholder="<?= lang('Ghi chú') ?>" ><?= old('note') ?></textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <?php foreach (EOrderStatus::toArray() as $item): ?>
                                            <option value="<?= $item ?>" <?= ($item == old('status')) ? 'selected' : '' ?>><?= lang("Order.order_status_{$item}") ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" @keyup="eventSearchProduct()" class="form-control" v-model="product_keyword_search" placeholder="<?= lang('Order.search_product') ?>">
                            <div class="input-group-append">
        ...
        data() {
            return {
                order: {
                    ...
                    phone: '<?= old('phone') ?>',
                    email: '<?= old('email') ?>',
                    payment_status: <?= old('payment_status') ?? EPaymentStatus::UNPAID ?>,
                    customer_paid: <?=  old('customer_paid') ?? 0 ?>,
                    voucher_code: '',
                },
                order_items: [],
                products_search: [],
