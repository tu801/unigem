...
<div class="row" id="postApp" data-cattype="post">
    ...
    <div class="col-md-9">
            ...
            <div class="card-body pad">
                <div class="form-group">
                    ...
                    <input type="text" name="title"
                        ...
                        placeholder="<?= lang('Post.title') ?>" value="<?= old('title') ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="10" class="textarea <?= session('errors.content') ? 'is-invalid' : '' ?>"
                        id="tmteditor" name="content"><?= old('content') ?></textarea>
                </div>
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-footer">
                ...
                <button class="btn btn-sm btn-success mr-2" id="postSave" name="save"
                    type="submit"><?= lang('Acp.save') ?> (F2)</button>
                <button class="btn btn-sm btn-primary mr-2" id="postSaveExit" name="save_exit"
                    type="submit"><?= lang('Acp.save_exit') ?> (F7)</button>
                <button class="btn btn-sm btn-primary mr-2" name="save_addnew"
                    type="submit"><?= lang('Acp.save_addnew') ?></button>
                <a href="<?= route_to('post') ?>" class="btn btn-sm btn-danger"
    ...
    <div class="col-md-3">
        <div class="card card-outline card-primary">
            <div class="card-body">
                <div class="form-group ">
                    <label><?= lang('Acp.lang') ?>: <span class="badge badge-info "> <?= $currentLang->name  ?></span>
                    </label>
                </div>
        ...
        <div class="card card-outline card-primary">
            <div class="card-body">
                ...
                <div class="form-group"
                    style="display: <?= (isset($catOld) && count($catOld) > 0) ? 'block' : 'none' ?>"
                    id="frm_cat_primary">
        ...
        <div class="card card-outline card-primary">
            <div class="card-body">
                <feature-img img-desc="<?= lang('Post.feature_image_desc') ?>" img-title="<?= lang('Post.image') ?>">
                </feature-img>
            </div>
        </div>
