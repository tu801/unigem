            ...
            <div class="card card-outline card-primary">
                <div class="card-body pad">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control <?= session('errors.title') ? 'is-invalid' : '' ?>" id="postInputTitle" placeholder="<?= lang('Post.title') ?>" value="<?= htmlspecialchars($itemData->title) ?>">
                        ...
                        <div class="custom-control mt-2 custom-checkbox">
                            ...
                            <label for="createNewSlug" class="custom-control-label"><?= lang('Post.create_new_slug') ?></label>
                        </div>
                    </div>

                    <post-slug full-slug="<?= $itemData->url ?>" slug="<?= $itemData->slug ?>" label="<?= lang('Post.post_url') ?>" post="<?= $itemData->id ?>" token="<?= csrf_hash() ?>" tkname="<?= csrf_token() ?>"></post-slug>
                    ...
                    <div class="form-group ">
                        ...
                        <textarea rows="10" class="textarea <?= session('errors.content') ? 'is-invalid' : '' ?>" id="tmteditor" name="content"><?= $itemData->content ?></textarea>
                    </div>
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card-body">
                        <div class="form-group ">
                            ...
                            <input id="title_word_count" class="form-control" name="seo_title" value="<?= $itemData->seo_meta->seo_title ?? '' ?>" />
                        </div>
                        <div class="form-group ">
                            <label><?= lang('Post.meta_keyword') ?></label>
                            <textarea class="form-control" name="seo_keyword"><?= $itemData->seo_meta->seo_keyword ?? '' ?></textarea>
                        </div>

                        <div class="form-group ">
                            <label><?= lang('Post.meta_description') ?></label> - <?= lang('Acp.meta_desc_left'); ?> <span id="word_left">300</span>
                            <textarea id="word_count" class="form-control" name="seo_description"><?= $itemData->seo_meta->seo_description ?? '' ?></textarea>
                        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    ...
                    <div class="form-group" style="display: <?= (isset($itemData->categories) && count($itemData->categories) > 0) ? 'block' : 'none' ?>" id="frm_cat_primary">
...
<link type="text/css" rel="stylesheet" href="<?= base_url("{$config->scriptsPath}/vuejs-plugins/multiselect/default.css") ?>" />
