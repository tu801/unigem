            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><?= lang('User.email') ?> <span
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><?= lang('User.username') ?> <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><?= lang('User.password') ?> <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="password"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><?= lang('User.repassword') ?> <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="password"
            ...
            <div class="card">
                <div class="card-footer">
                    <div class="col-sm-12 col-sm-offset-2">
                        ...
                        <a href="<?= route_to('customer') ?>" class="btn btn-default"
