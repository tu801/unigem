<?php
return [
    'post_title'                    => 'Post Management',
    'title_add'                     => 'Add Post',
    'title_add_custom'              => 'Add {0}',
    'edit_title'                    => 'Edit Post',
    'page_title'                    => 'Page Management',
    'add_page_title'                => 'Add New Page',
    'edit_page_title'               => 'Edit Page Content',
    ...
    'post_url'                      => 'Post URL',
    'category'                      => 'Category',
    'select_cat_holder'             => 'Select Category',
    ...
    'post_position'                 => 'Post Display Position',
    ...
    'addPageSuccess'                => "Successfully added new page #{0}",
    'editSuccess'                   => 'Successfully updated post #{0}',
    'updateSlug_success'            => 'Successfully updated new URL',
    'delete_success'                => 'Successfully deleted post #{0}',
    'recover_success'               => 'Successfully recovered post #{0}',
    'publish_post_success'          => 'Successfully published post #{0}',
