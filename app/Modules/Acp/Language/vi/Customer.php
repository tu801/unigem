...
return [
    ...
    'add_title'             => 'Thêm khách hàng',
    'edit_title'            => 'Sửa thông tin khách hàng',
    'detail_title'          => 'Thông tin khách hàng',
    ...
    'service_note'       => 'Ghi Chú',
    'add_new_service'    => 'Thêm dịch vụ',

    'service_status_new'        => 'Mới',
    'service_status_inprogress' => 'Đang tiến hành',
    'service_status_done'       => 'Đã hoàn thành',

    // success message
    'addSuccess'                => 'Đã thêm khách hàng thành công #{0}',
    'addCustomerLog'            => '#{0} đã thêm khách hàng #{1}',
    'editCustomerLog'           => '#{0} đã sửa thông tin khách hàng #{1}',
    'editSuccess'               => '#{0} đã sửa thành công thông tin khách hàng #{1}',

    'addServiceSuccess'  => 'Đã thêm dịch vụ mới thành công #{0}',
    'editServiceSuccess' => 'Đã sửa dịch vụ thành công #{0}',
    ...
    'customer_id_required' => 'Dữ liệu khách hàng không đúng',
    'customer_not_exist'   => 'Khách hàng này không tồn tại',
    ...
    'doctor'                           => 'Bác Sĩ',
    'addServiceGuaranteeSuccess'       => 'Ghi Chú Bảo Hành Thành Công',
