...
$routes->group('acp', ['namespace' => 'Modules\Acp\Controllers'], function ($routes) {
    ...
    //category routes
    $routes->group('category', ['namespace' => 'Modules\Acp\Controllers\Blog'], function ($routes) {
        ...
        $routes->get('remove/(:num)', 'Category::remove/$1', ['as' => 'remove_category']);
    ...
    //post routes
    $routes->group('post', ['namespace' => 'Modules\Acp\Controllers\Blog'], function ($routes) {
