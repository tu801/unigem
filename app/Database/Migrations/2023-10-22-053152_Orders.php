...
class Orders extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'user_init'	      	=> ['type' => 'bigint', 'unsigned' => true, 'null' => true],
            ...
            'exchange_rate'     => ['type' => 'decimal', 'constraint' => "12,6", 'default' => 0],
            'exchange_rate_id'  => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
            'sub_total'         => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
            'voucher_code'      => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
            'discount_amount'   => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
            'shipping_amount'   => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
            'total'             => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
            'total_amount_vnd'  => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
            'customer_paid'     => ['type' => 'decimal', 'constraint' => "12,6", 'null' => true, 'default' => 0],
        ...
        $this->forge->addField([
            ...
            'unit_price'        => ['type' => 'decimal', 'constraint' => "12,6", 'unsigned' => true, 'default' => 0],
            'quantity'          => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
            'total'             => ['type' => 'decimal', 'constraint' => "12,6", 'unsigned' => true, 'default' => 0],
        ...
        $this->forge->addField([
            ...
            'rate'                  => ['type' => 'decimal', 'constraint' => "12,6"],
