 ...
 * @param {object} startPoint Cells selected to apply change.
...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
  ...
  function setStartPoint() {
    if (!startPoint || !startPoint.tagName || startPoint.tagName.toLowerCase() !== 'td' && startPoint.tagName.toLowerCase() !== 'th') {
      // Impossible to identify start Cells point
      return;
    }
   ...
   * @param {object} baseCell Cells affected by this position.
  ...
  /**
   * Recover free index of row to append Cells.
   *
   ...
   * @param {object} cell Cells to recover information.
   */
