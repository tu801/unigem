                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ( response.error == 0 ) {
                            ...
                            var input = "<input type='hidden' class='tmt_inp_tagcloud' name='tagcloud[]' value='"+response.tagsdata.slug+"' >";
                            var btnRemove = "<a class=\"tag-item-remove ml-2 text-light\" href=\"#\">x</a>"

                            var html = "<li class=\"list-inline-item\"><span class=\"badge badge-primary\">"+response.tagsdata.title+btnRemove+"</span>"+input+"</li>";
                    ...
                    statusCode: {
                        ...
                        403: function() {
                            Swal.fire({
                                icon: 'error',
                                title: 'Có lỗi xảy ra! Vui lòng refresh lại trình duyệt của bạn rồi tiếp tục.',
                            })
                        }
                    }
                });
