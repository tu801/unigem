  ...
  var filterProducts = function () {
    ...
    function applyFilters() {
      ...
      $(".wrapper-shop .card-product").each(function () {
        ...
        const priceText = product.find(".sort-price").text().replace("$", "");
  ...
  var filterSort = function () {
    ...
    function applyFilter(sortValue, isListActive) {
      ...
      if (sortValue === "price-low-high") {
        products.sort(
          (a, b) =>
            parseFloat($(a).find(".sort-price").text().replace("$", "")) -
            parseFloat($(b).find(".sort-price").text().replace("$", ""))
        );
        ...
        products.sort((a, b) => {
          const dateA = new Date($(a).find(".publish-date").text());
          const dateB = new Date($(b).find(".publish-date").text());
          return dateB - dateA;
        });
